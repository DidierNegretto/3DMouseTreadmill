...
static void mavlink_test_speed_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_speed_info_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_speed_info_pack(system_id, component_id, &msg , packet1.time , packet1.speed_x , packet1.speed_y , packet1.speed_z );
    mavlink_msg_speed_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_speed_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time , packet1.speed_x , packet1.speed_y , packet1.speed_z );
    mavlink_msg_speed_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_speed_info_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_speed_info_send(MAVLINK_COMM_1 , packet1.time , packet1.speed_x , packet1.speed_y , packet1.speed_z );
    mavlink_msg_speed_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_speed_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_speed_setpoint_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_speed_setpoint_pack(system_id, component_id, &msg , packet1.setpoint_x , packet1.setpoint_y , packet1.setpoint_z );
    mavlink_msg_speed_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_speed_setpoint_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.setpoint_x , packet1.setpoint_y , packet1.setpoint_z );
    mavlink_msg_speed_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_speed_setpoint_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_speed_setpoint_send(MAVLINK_COMM_1 , packet1.setpoint_x , packet1.setpoint_y , packet1.setpoint_z );
    mavlink_msg_speed_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_motor_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_motor_setpoint_t packet1, packet2;
        ...
        packet1.motor_z = packet_in.motor_z;
    ...
    mavlink_msg_motor_setpoint_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_motor_setpoint_pack(system_id, component_id, &msg , packet1.time , packet1.motor_x , packet1.motor_y , packet1.motor_z );
    mavlink_msg_motor_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_motor_setpoint_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time , packet1.motor_x , packet1.motor_y , packet1.motor_z );
    mavlink_msg_motor_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_motor_setpoint_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_motor_setpoint_send(MAVLINK_COMM_1 , packet1.time , packet1.motor_x , packet1.motor_y , packet1.motor_z );
    mavlink_msg_motor_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
