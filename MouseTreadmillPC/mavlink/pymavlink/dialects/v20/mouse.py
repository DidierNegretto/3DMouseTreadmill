...
class MAVLink_heartbeat_message(MAVLink_message):
        ...
        present and responding.                         Sender = STM32
        Receiver = PC
        '''
...
class MAVLink_speed_info_message(MAVLink_message):
        '''
        The message giving the actual speed of the motor.
...
class MAVLink_mode_selection_message(MAVLink_message):
        '''
        This message is used to select the mode of the STM32
