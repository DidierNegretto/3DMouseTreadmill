...
\section{User manual for mouse treadmill software}
...
For the closed-loop control a simple PI controller is used. This can be improved in future works to allow for faster and better performance control.
